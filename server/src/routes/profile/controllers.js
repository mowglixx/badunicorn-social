...
exports.addUser = async (req, res, next) => {
  try {
    ...
    newUser && await Profile.create({userId: newUser._id})  // create a profile for the new user
...
exports.listUsers = async (req, res, next) => {
  try {
    ...
    const listUsers = userReq ? await User.find({'userId': { $regex: userReq, $options: "gi" }}) :await User.find({})
